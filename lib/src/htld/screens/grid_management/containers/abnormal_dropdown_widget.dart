...
class AbnormalDropdownWidget extends StatelessWidget{
  ...
  final TextEditingController nameAbnormal = TextEditingController();
              ...
              Expanded(
                child: DropdownSearch<OptionModelString>(
                  emptyBuilder: (context, searchEntry) => const Center(
                      child: Text('Không tìm thấy bất thường',
                  ...
                  dropdownSearchDecoration: InputDecoration(
                      ...
                      enabledBorder: OutlineInputBorder(
                        borderSide: BorderSide(
                            color:
                                (invalid && defaultOption == null)
                                    ? Colors.red
                                    : Colors.grey),
                      )),
                  items: options ?? <OptionModelString>[],
                  onChanged: disable == false
                      ? (data) async {
  ...
  OptionModelString getDefaultOption() {
    final list = options
            ?.where((element) => element.value == defaultOption)
            ?.toList() ??
        [];
  ...
  Widget _customDropDownString(
    ...
    return Text(
      selectedItems == null ? (placeholder ?? '') : selectedItems.title,
      style: TextStyle(
