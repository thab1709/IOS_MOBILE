...
class TDialogPicture extends StatefulWidget {
  final List<TImages> listImage;
  ...
  @override
  State<TDialogPicture> createState() => _DialogPictureState();
}

class _DialogPictureState extends State<TDialogPicture> {
  List<TImages> listImageCurrent = [];
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => TViewImagesScreen(
                            ...
                            child: GestureDetector(
                              onTap: () async {
                                ...
                                setState(() {
                                  if (!widget.isLogbook) {
                                    listImageCurrent
                                        .remove(listImageCurrent[index]);
                                  }
                                  if (listImageCurrent.isEmpty &&
                                      widget.isGroup) {
                                    Get.back();
                                  }
                                });
