...
enum ChooseLineEnum { createTicket, addNewBranch, editBranch }

class ListLineView extends StatefulWidget {
  const ListLineView(
      {this.lineModel,
      this.chooseLineEnum,
      this.lineBranchInfo,
  ...
  State<StatefulWidget> createState() {
    return ListLineViewState();
  }
}

class ListLineViewState extends State<ListLineView> {
