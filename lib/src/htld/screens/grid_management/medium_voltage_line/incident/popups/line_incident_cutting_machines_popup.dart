...
class LineIncidentCuttingMachinesPopup extends BasePopupWidget {
  ...
  final _controller = LineCuttingMachinesController();
...
class LineCuttingMachinesController extends BasePopupController {
  Rx<LineCuttingMachineModel> model = LineCuttingMachineModel().obs;
  ...
  Future getData() async {
    await super.getData();
    Future online() async {
      final response = await repository.getLineCuttingMachine(
      ...
      if (response.isLoadSuccess) {
        model.value = response?.data ?? LineCuttingMachineModel();
    ...
    void offline() {
      final response = LocalDataManager.shared
          .getLinePopup<LineCuttingMachineModel>(
              lineTicketController.ticketId,
              lineBranchInfo.id,
              popupsDataModel.equipmentId,
              popupsDataModel.inspectionCategory);
      model.value = response ?? LineCuttingMachineModel();
      model.value.title = popupsDataModel.equipmentName;
      update();
    }
  ...
  Future updateData() async {
    ...
    Future offline({bool isOffline = true}) async {
      ...
      final result = await LocalDataManager.shared
          .saveLinePopup<LineCuttingMachineModel>(
              model.value,
              lineTicketController.ticketId,
              lineBranchInfo.id,
              popupsDataModel.equipmentId,
    ...
    Future online() async {
      final params = {
        ...
        'lineCuttingMachine': model.toJson()
      };
