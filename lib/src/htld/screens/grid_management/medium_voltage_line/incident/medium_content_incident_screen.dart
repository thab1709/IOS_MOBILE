...
class MediumContentIncidentScreen extends StatefulWidget {
  final Function next;

  const MediumContentIncidentScreen({this.next});

  @override
  _MediumContentIncidentScreenState createState() =>
      _MediumContentIncidentScreenState();
}

class _MediumContentIncidentScreenState
    extends State<MediumContentIncidentScreen>
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            children: [
              () {
                controller.lineContent.value.lineRightsOfWay.problemPositions
                    ?.firstWhere((element) => element.fieldValue == 2,
                        orElse: () => null)
                    ?.problemValue ??= KCOptions.first.value;
