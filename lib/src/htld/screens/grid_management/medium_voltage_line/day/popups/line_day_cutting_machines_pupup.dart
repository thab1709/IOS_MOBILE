...
import 'package:evnmobile/src/htld/screens/grid_management/medium_voltage_line/incident/popups/line_incident_cutting_machines_popup.dart';
...
class LineDayCuttingMachinesPopup extends BasePopupWidget {
      ...
      child: Obx(() => Column(
            ...
            children: [
              ...
              ELineDropDown(
                ...
                title: 'Bên ngoài hộp điều khiển',
                index: 2,
                enable: _controller.isEnable(),
                equipmentModel: equipmentModels,
                problemPositions: _controller.model.value?.problemPositions
              ...
              ELineDropDown(
                LineOption.DBVH_K_KHD_H_Option,
