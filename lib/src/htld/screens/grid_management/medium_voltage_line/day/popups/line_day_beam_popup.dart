...
import 'package:evnmobile/src/htld/screens/grid_management/medium_voltage_line/incident/popups/line_incident_beam_popup.dart';
...
class LineDayBeamPopup extends BasePopupWidget {
  LineDayBeamPopup(
    ...
    return SingleChildScrollView(
      child: Obx(() => Column(
            ...
            children: [
              ...
              ETextField(
                title: 'Vật liệu lạ bám vào xà',
                horizontalPadding: 0,
                isRequire: true,
                enable: _controller.isEnable(),
                value: _controller.model.value.materialClingingToBeam ??=
                    "Không",
                onChange: (value) {
                  _controller.model.value.materialClingingToBeam = value;
                },
              ),
              ELineDropDown(
                LineOption.DBVH_M_L_G_M_Option,
                title: 'Bulong, Ecu',
                index: 2,
                enable: _controller.isEnable(),
                equipmentModel: equipmentModels,
