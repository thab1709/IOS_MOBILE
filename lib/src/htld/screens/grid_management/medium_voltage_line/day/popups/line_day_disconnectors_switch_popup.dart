...
import 'package:evnmobile/src/htld/screens/grid_management/medium_voltage_line/incident/popups/line_incident_disconnectors_switch_popup.dart';
...
class LineDayDisconnectorsSwitchPopup extends BasePopupWidget {
    ...
    return SingleChildScrollView(
      child: Obx(() => Column(
            ...
            children: [
              ...
              ELineDropDown(
                LineOption.DBVH_G_CV_TXKT_LXTDG_NA_Option,
                title: 'Lưỡi dao',
                index: 2,
                enable: _controller.isEnable(),
                equipmentModel: equipmentModels,
              ...
              ELineDropDown(
                LineOption.DBVH_K_KHD_H_NA_Option,
                title: 'Cơ cấu truyền động, chốt an toàn, lẫy khóa',
                index: 3,
                enable: _controller.isEnable(),
                equipmentModel: equipmentModels,
                defaultValue: _controller.model.value
