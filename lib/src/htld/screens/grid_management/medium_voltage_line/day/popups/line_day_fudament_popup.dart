...
import 'package:evnmobile/src/htld/screens/grid_management/medium_voltage_line/incident/popups/line_incident_fudament_popup.dart';
...
class LineDayFudamentPopup extends BasePopupWidget {
    ...
    return SingleChildScrollView(
      child: Obx(() => Column(
            ...
            children: [
              ...
              ELineDropDown(
                LineOption.BT_CVND_CRTN_NA_Option,
                title: 'Mặt đất, đường xung quanh',
                index: 2,
                enable: _controller.isEnable(),
                equipmentModel: equipmentModels,
                defaultValue: _controller.model.value
                    .getProblemValue(2, LineContentOption.normal),
                problemPositions: _controller.model.value?.problemPositions
