...
class MediumContentDayScreen extends StatefulWidget {
  const MediumContentDayScreen({this.next});

  final Function next;

  @override
  _MediumContentDayScreenState createState() => _MediumContentDayScreenState();
}

class _MediumContentDayScreenState extends State<MediumContentDayScreen>
                  ...
                  child: Column(
                    children: [
                      const Padding(
                        ...
                        child: ESectionTitle('Nội dung kiểm tra TT'),
                      ),
                      Obx(() => Column(
