...
class TViewImagesScreen extends StatefulWidget {
  TViewImagesScreen({this.initialIndex = 0, this.galleryItems, Key key})
      : super(key: key) {
  ...
  final List<TImages> galleryItems;

  @override
  State<TViewImagesScreen> createState() => _ViewImagesScreenState();
}

class _ViewImagesScreenState extends State<TViewImagesScreen> {
  int currentIndex;
