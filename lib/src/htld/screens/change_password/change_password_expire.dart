...
class ChangePasswordExpireScreen extends StatefulWidget {
  const ChangePasswordExpireScreen({this.isExpired = true});
...
class _ChangePasswordExpireState extends State<ChangePasswordExpireScreen> {
              ...
              children: [
                ...
                Form(
                  ...
                  child: TextFormField(
                        ...
                        validator: (value) => AuthValidator().retypePassword(value, _newPasswordController.text),
                        obscureText: true,
                        decoration: const InputDecoration(
                      ...
                      action: () {
                        if(widget.isExpired){
                          if (_keyUsername.currentState.validate() &&
                            ...
                            _controller.changePasswordExpired(_usernameController.text,
