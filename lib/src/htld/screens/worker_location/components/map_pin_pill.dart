// @dart=2.9
import 'package:evnmobile/src/htld/screens/worker_location/models/pin_pill_info.dart';
...
class MapPinPillComponent extends StatefulWidget {
  ...
  const MapPinPillComponent({ this.pinPillPosition, this.currentlySelectedPin});
