...
class InsulationModel extends PopupBaseModel {
  int insulation;
  int contactAtTerminals;
  int sound;
  int possibleProblematic;
  int accessoriesOfInsulation;
  int handlingInCheck;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['sound'] = sound;
    map['accessoriesOfInsulation'] = accessoriesOfInsulation;
  ...
  @override
  bool validateData() {
    return ![insulation, contactAtTerminals, sound,
      accessoriesOfInsulation, handlingInCheck, specificPhenomena,
      possibleProblematic,  suggestedHandlingOfAbnormal].contains(null);
  }
