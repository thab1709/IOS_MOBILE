...
class OneWaySystem extends PopupBaseModel {
  int operatingStatus;
  String voltage;
  ...
  OneWaySystem.fromJson(JSON data) {
  ...
  @override
  bool validateData() {
    return ![operatingStatus, voltage, specificPhenomena, problems, resistorInsulation, handlingImmediatelyInspection, suggestedHandlingOfAbnormal].contains(null);
  }
}
