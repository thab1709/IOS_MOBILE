...
class HighPressureCable extends PopupBaseModel {
  int operatingStatus;
  int pdStatus;
  ...
  HighPressureCable.fromJson(JSON data) {
    operatingStatus = data['operatingStatus'].integer;
    pdStatus = data['pdStatus'].integer;
  ...
  @override
  bool validateData() {
    return ![operatingStatus, pdStatus, specificPhenomena, possibleProblematic, handlingImmediatelyInspection, suggestedHandlingOfAbnormal].contains(null);
  }
