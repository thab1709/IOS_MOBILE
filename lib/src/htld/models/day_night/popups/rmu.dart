...
class Rmu extends PopupBaseModel {
  ...
  bool validateData() {
    return ![externalCondition, sound, driveStructureClosed, sf6Gas,
      measurePartialDischargeOptions, cableFaultRelay,
      dryingResistance, insulation, springPressesContact, bolts, groundingEquipment,
