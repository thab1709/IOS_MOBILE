...
class LineInsulationModel extends PopupBaseModel {
  String damaged;
  ...
  LineInsulationModel.fromJson(JSON json) {
  ...
  bool validateData() {
    ...
    if (_ticketController.argument.ticketType != TicketType.incidentDay) {
      return ![specificPhenomena, suggestedHandlingOfAbnormal, damaged, materialClingToInsulation].contains(null) && listDistinct.length == 7;
    } else {
      return ![specificPhenomena, suggestedHandlingOfAbnormal].contains(null) && listDistinct.length == 6;
    }
  }
}
