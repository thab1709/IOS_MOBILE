...
class HScanQRScreen extends StatefulWidget {
  const HScanQRScreen({Key key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _ScanQRScreenState();
}

class _ScanQRScreenState extends State<HScanQRScreen> {
  Barcode result;
  ...
  void _onQRViewCreated(QRViewController controller) {
    ...
    controller.scannedDataStream.listen((scanData) {
      ...
      //   result = scanData;
      // });
      if (scanData.code is String && !isProcessing) {
        isProcessing = true;
