...
class _GroupCheckListViewState extends State<GroupCheckListView> {
  ...
  void initState() {
    ...
    Future.delayed(const Duration(milliseconds: 100), () async {
      await _controller.getGroupCheck();
    });
  }
  ...
  Widget build(BuildContext context) {
    return Obx(() => Scaffold(
          ...
          body: SingleChildScrollView(
            child: Column(
              children: [
                for(var i =0; i<_controller.tbaGroupCheckModel.value.groups.length; i++)
