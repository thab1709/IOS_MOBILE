...
class LightingScreen extends BasePopupWidget {

  LightingScreen({@required EquipmentModel model, List<EquipmentModel> equipmentsDestination, String ticketId}) {
  ...
  final _controller = LightingController<CsvModel>();
