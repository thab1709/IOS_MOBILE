...
import 'package:evnmobile/src/htdct/models/line/popups/insulation_model.dart';
...
class InsulationScreen extends BasePopupWidget {

  InsulationScreen({@required EquipmentModel model, List<EquipmentModel> equipmentsDestination, String ticketId}) {
  ...
  final _controller = InsulationController<InsulationModel>();
