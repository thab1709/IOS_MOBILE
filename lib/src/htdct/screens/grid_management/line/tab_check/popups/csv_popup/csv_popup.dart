...
class CSVPopupScreen extends BasePopupWidget {

  CSVPopupScreen({@required EquipmentModel model, List<EquipmentModel> equipmentsDestination, String ticketId}) {
  ...
  final _controller = CSVController<CsvModel>();
