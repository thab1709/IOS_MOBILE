...
import '../../../../../../models/day_night/popups/compensating_capacitor_model.dart';
...
class CompensatingCapacitorScreen extends BasePopupWidget {
  CompensatingCapacitorScreen({@required EquipmentModel model, List<EquipmentModel> equipmentsDestination, String ticketId}) {
  ...
  final _controller = CompensatingCapacitorController<CompensatingCapacitorModel>();
