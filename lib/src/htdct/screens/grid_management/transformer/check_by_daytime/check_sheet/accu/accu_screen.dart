...
import 'package:evnmobile/src/htdct/screens/grid_management/transformer/check_by_daytime/check_sheet/accu/check_accu/check_accu_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

import '../../../../../../common/constance/app_color.dart';
import '../../../../../../models/day_night/popups/accu_model.dart';
import '../../../../base/base_popup_wigget.dart';
import 'accu_controller.dart';

class ACCUScreen extends BasePopupWidget {
  ACCUScreen({@required EquipmentModel model, List<EquipmentModel> equipmentsDestination, String ticketId}) {
  ...
  final _controller = ACCUController<ACCUModel>();
