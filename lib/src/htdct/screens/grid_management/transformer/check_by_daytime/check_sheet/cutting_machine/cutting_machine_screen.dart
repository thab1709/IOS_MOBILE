...
import '../../../../../../models/day_night/popups/cutting_machine_model.dart';
import '../../../../base/base_popup_wigget.dart';
import 'cutting_machine_controller.dart';

class CuttingMachineScreen extends BasePopupWidget {
  CuttingMachineScreen({@required EquipmentModel model, List<EquipmentModel> equipmentsDestination, String ticketId}) {
  ...
  final _controller = CuttingMachineController<CuttingMachineModel>();
