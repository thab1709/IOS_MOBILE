...
import '../../../../../../models/day_night/popups/isolation_knife_model.dart';
import '../../../../base/base_popup_wigget.dart';
import 'isolation_knife_controller.dart';

class IsolationKnifeScreen extends BasePopupWidget {
  IsolationKnifeScreen({@required EquipmentModel model, List<EquipmentModel> equipmentsDestination, String ticketId}) {
  ...
  final _controller = IsolationKnifeController<IsolationKnifeModel>();
