...
Widget OpenratingVoltageScreen(TUController _controller) {
  Widget _buildHeader() // Điện áp từng pha
  {
    ...
    return ExpansionWidget(
      ...
      title: '1. ${HighElectricStrings.operatingVoltageTU}',
      children: <Widget>[
        // kết luận
        ESingleDropDown(
          OptionsType.normal_weirdo.getOptions,
          value: model.voltageEachPhase,
          isDisable: true,
        ),
        //Giá trị trên rơle ngăn lộ
        if (_controller.transformerTicketController.checkAbnormalNotify(
          ...
          CheckWidget(
            ...
            onSelectedAbnormalOption: ({value, title}) {
              model.setAbnormal(
                Abnormals(
                  ...
                  childCategory: title,
                  parentCategory:
                      '1. ${HighElectricStrings.operatingVoltageTU}',
            ...
            title: '1.1.Điện áp vận hành(A)',
            checkListItem: [
              CheckModel(
                title: 'Urole',
                value: model.urole?.toString(),
                isNumber: true,
                isRequired: false,
                onChange: (value) {
                  ...
                  model.urole = value.toDoubleOrNull();
                  // _controller.updateDegreeDifference();
                },
              ),
              CheckModel(
                title: 'UCông tơ',
                value: model.uMeter?.toString(),
                isNumber: true,
                isRequired: false,
                onChange: (value) {
                  if (_controller.triggerWaringValue == false) {
                  ...
                  model.uMeter = value.toDoubleOrNull();
                  // _controller.updateDegreeDifference();
                },
              ),
              CheckModel(
