...
class TIScreen extends BasePopupWidget {
  TIScreen({@required EquipmentModel model, List<EquipmentModel> equipmentsDestination, String ticketId}) {
  ...
  final _controller = TIController<TiModel>();
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            if(_controller.transformerTicketController.checkAbnormalNotify(_controller.dataModel.value.operatingParameters,nonCheck: true, title: 1))
