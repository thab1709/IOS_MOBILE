...
class CapacitorNightScreen extends BasePopupWidget {
  CapacitorNightScreen({@required EquipmentModel model, List<EquipmentModel> equipmentsDestination, String ticketId}) {
  ...
  final _controller = CapacitorNightController<TransformerNightModel>();
