...
class CuttingMachineNightScreen extends BasePopupWidget {
  CuttingMachineNightScreen({@required EquipmentModel model, List<EquipmentModel> equipmentsDestination, String ticketId}) {
  ...
  final _controller = CuttingMachineNightController<TransformerNightModel>();
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            cuttingMachineNightContent(_controller),
          ],
        ),
      ),
    );
