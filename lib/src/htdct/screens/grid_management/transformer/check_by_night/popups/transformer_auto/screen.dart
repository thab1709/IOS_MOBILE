...
class TransformerAutoNightScreen extends BasePopupWidget {
  TransformerAutoNightScreen({@required EquipmentModel model, List<EquipmentModel> equipmentsDestination, String ticketId}) {
  ...
  final _controller = TransformerAutoNightController<TransformerNightModel>();
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            transformerAutoNightContent(_controller),
          ],
        ),
      ),
    );
