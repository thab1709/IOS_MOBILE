...
class HistoryController extends GetxController {
  ...
  RxList<AbnormalHistoryModel> listAbnormal = RxList.empty();
  List<AbnormalHistoryModel> listAbnormalOriginal = List.empty(growable: true);
  ...
  List<AbnormalHistoryModel> find()
  {
