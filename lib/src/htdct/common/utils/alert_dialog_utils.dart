...
Future<void> hShowMyDialogOkCancel(String content,
    {String title,
    String firstTitle,
...
Future<void> hShowDialogOneButton(String content, {Function action}) async {
  if (content == null) {
    return;
  }
  final size = Get.size.width;
                    ...
                    GestureDetector(
                      ...
                      child: Padding(
                        ...
                        child: content?.startsWith('<html>') == true
                            ? Html(data: content)
                            : Text(content ?? 'Lỗi không xác định', maxLines: 14, overflow: TextOverflow.ellipsis,),
                      ),
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.end,
...
Future<void> hShowDialogVersionApp(String content, BuildContext context, {Function action}) async {
  if (content == null) {
    return;
  }
  final size = Get.size.width;
