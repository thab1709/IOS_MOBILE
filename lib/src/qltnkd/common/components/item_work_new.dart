...
class ItemWorkNew extends StatelessWidget {
  final int index;
        ...
        if (workMergeModel.isExpand)
          Column(
            children: [
              ...
              if (workMergeModel.reportMergeModels != null &&
                  workMergeModel.reportMergeModels.isNotEmpty)
                ...workMergeModel.reportMergeModels
                    .take(11)
                    .map((r) => _buildItemReport(r))
                    .toList(),
            ],
          )
      ],
  ...
  Widget _buildReportHeader(ReportMergeModel reportMergeModel) {
    return Column(
      children: [
        Row(
          children: [
