...
import 'package:evnmobile/src/qltnkd/screens/verification_report/certificate/histories/certificate_history_controller.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class CertificateApprovalHistoryScreen extends StatefulWidget {
  const CertificateApprovalHistoryScreen({this.certificateId});
...
class HistoryReportApproveState extends State<CertificateApprovalHistoryScreen> {
  final _controller = CertificateApprovalHistoryController();

  @override
  void initState() {
    super.initState();
    _controller.getApprovalHistory(formReportId: widget.certificateId);
  }
