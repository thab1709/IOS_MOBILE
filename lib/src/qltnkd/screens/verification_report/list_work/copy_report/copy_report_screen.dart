...
class CopyReportScreen extends StatefulWidget {
  const CopyReportScreen({@required this.scheduleId, @required this.equipmentDetailId, this.equipmentTypeId, this.groupType = 0, Key key}) : super(key: key);
  final String scheduleId;
  final String equipmentDetailId;
...
class _CopyReportScreenState extends State<CopyReportScreen>
  ...
  void initState() {
    ...
    controller.scheduleId = widget.scheduleId;
    controller.equipmentDetailId = widget.equipmentDetailId;
    controller.equipmentTypeId = widget.equipmentTypeId;
