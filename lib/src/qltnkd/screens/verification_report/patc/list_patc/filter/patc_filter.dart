...
import 'package:evnmobile/src/qltnkd/screens/verification_report/survey_report/repository/survey_report_repository.dart'; // To fetch units and constructions
...
class PatcFilter extends StatefulWidget {
  @override
  _PatcFilterState createState() => _PatcFilterState();
}

class _PatcFilterState extends State<PatcFilter> {
  final ListPatcController _controller = Get.find();
  ...
  final _repository = SurveyReportRepository(); // Used for getUnits / getConstructions as they are likely the same
  ...
  void initState() {
    ...
    // PATC status doesn't exactly match SurveyReport but we map it via EnumSurveyReport tabs
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text('Công trình khảo sát', style: TextStyle(fontWeight: FontWeight.bold)),
                    const SizedBox(height: 8),
                    SingleStringDropDown(
                      _constructions,
