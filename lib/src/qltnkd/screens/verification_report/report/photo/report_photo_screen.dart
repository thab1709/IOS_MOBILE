...
import 'package:evnmobile/src/qltnkd/screens/verification_report/report/photo/report_photo_controller.dart';
      ...
      floatingActionButton: widget.isEnable ? FloatingActionButton(
        onPressed: () async {
          if (_controller.images.length >= 10) {
            await rShowDialogOneButton('Bạn chỉ có thể lưu tối đa 10 ảnh');
            return;
          }
