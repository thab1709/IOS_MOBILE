...
import 'tab_report_meter_controller.dart';

class TabReportMeterScreen extends StatefulWidget {
  final String statusReport;
  final int index;

  const TabReportMeterScreen({
    this.statusReport,
    this.index,
  });
  ...
  State<StatefulWidget> createState() {
    return _TabReportState();
  }
}

class _TabReportState extends State<TabReportMeterScreen>
