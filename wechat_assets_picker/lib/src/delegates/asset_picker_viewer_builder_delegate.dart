...
abstract class AssetPickerViewerBuilderDelegate<Asset, Path> {
  ...
  /// 资源选择的最大数量
  final int? maxAssets;
  final List<String>? imagesSelectedInPopup;
  ...
  void selectAsset(BuildContext context, Asset entity, String imageName) {
    if (maxAssets != null && selectedCount >= maxAssets!) {
      return;
    }
    if(imagesSelectedInPopup?.contains(imageName) == true){
      showDialog<void>(
        context: context,
            ...
            content: SingleChildScrollView(
              child: ListBody(
                children: const <Widget>[
                  Text('Không thể chọn ảnh này vì bạn đã sử dụng ảnh này trước đó.', style: TextStyle(color: Colors.black)),
                ],
              ),
            ),
            actions: <Widget>[
...
class DefaultAssetPickerViewerBuilderDelegate
  ...
  DefaultAssetPickerViewerBuilderDelegate({
    ...
    int? maxAssets,
    List<String>? imagesSelectedInPopup,
        ...
        builder: (_, AssetPickerViewerProvider<AssetEntity>? provider, __) {
          ...
          return MaterialButton(
            ...
            onPressed: () {
              ...
              selectAsset(context, currentAsset, currentAsset.title ?? '');
              Navigator.of(context).pop(
  ...
  /// 苹果系列系统的选择按钮
  Widget _appleOSSelectButton(BuildContext context, bool isSelected, AssetEntity asset) {
    ...
    return Padding(
      ...
      child: GestureDetector(
        ...
        onTap: () {
          ...
          selectAsset(context, asset, asset.title ?? '');
        },
  ...
  /// 安卓系统的选择按钮
  Widget _androidSelectButton(BuildContext context, bool isSelected, AssetEntity asset) {
            ...
            return ChangeNotifierProvider<
              ...
              child: Selector<AssetPickerViewerProvider<AssetEntity>,
                ...
                builder: (_, List<AssetEntity> currentlySelectedAssets, __) {
                  ...
                  if (isAppleOS) {
                    return _appleOSSelectButton(context, isSelected, asset);
                  }
