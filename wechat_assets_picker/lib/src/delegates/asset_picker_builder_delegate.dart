...
abstract class AssetPickerBuilderDelegate<Asset, Path> {
  ...
  /// 主要的资源查看网格部件
  Future<Widget> assetsGridBuilder(BuildContext context);
...
class DefaultAssetPickerBuilderDelegate
                        ...
                        child: Column(
                          children: <Widget>[
                            Expanded(
                              ...
                              builder: (_, AsyncSnapshot<Widget> snap) {
                                return snap.data ?? Container();
                              },
                              future: assetsGridBuilder(context),
                            )),
  ...
  @override
  Future<Widget> assetsGridBuilder(BuildContext context) async {
  ...
  Widget imageAndVideoItemBuilder(
    ...
    final AssetEntityImageProvider imageProvider = AssetEntityImageProvider(
      asset,
      isOriginal: false,
      thumbnailSize: ThumbnailSize(gridThumbSize, gridThumbSize),
    );
        ...
        return GestureDetector(
          onTap: () async {
            ...
            final List<AssetEntity>? result =
              ...
              themeData: theme,
              imagesSelectedInPopup: provider.imagesSelectedInPopup,
      ...
      builder: (BuildContext context, _, __) {
        ...
        final GestureDetector selectorWidget = GestureDetector(
          ...
          onTap: () async {
            ...
            provider.selectAsset(context, asset, asset.title ?? '');
            if (isSingleAssetMode && !isPreviewEnabled) {
              Navigator.of(context).maybePop(provider.selectedAssets);
            }
          },
